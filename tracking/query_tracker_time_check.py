...
if __name__ == "__main__":
    ...
    indexes = ["index_sift_learn", # warmup
               "index_sift_query", "index_sift_30000",
               "index_sift_learn", "index_sift_300000",
               "index_sift_base"]
    ...
    for index in indexes:
        for experiment in experiments:
            ...
            result_path = os.path.join(experiment_folder, f"res_{index}")
